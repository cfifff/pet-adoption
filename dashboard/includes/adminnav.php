 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Pets Adoption</a>
            </div>
            
            <ul class="nav navbar-right top-nav">
                <?php if($_SESSION['role'] !== 'admin') { ?> <li><a href="./uploadpet.php">UPLOAD PET DATA</a></li> <?php } ?>
                <li class="dropdown">
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php if($_SESSION['role'] == 'admin') {
                   ...
                   <li>
                    ...
                    <li>
                         <a href="./newpet.php" data-toggle="collapse" data-target="#user"><i class="fa fa-fw fa-users"></i> Add New Pet <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="pet" class="collapse">
                            <li>
                                <a href="./newpet.php">Upload new pet</a>
                            </li>
                    ...
                    <li>
                         <a href="javascript:;" data-toggle="collapse" data-target="#user"><i class="fa fa-fw fa-users"></i> My PETS <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./pets.php">View All PETS</a>
                            </li>
                            <li>
                                <a href="./uploadpet.php">Upload Pet</a>
                            </li>
