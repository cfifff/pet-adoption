            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-xs-4">
            <a href="uploadpet.php" class="btn btn-primary">Add New Pet</a>
            </div>
                         MY PETS
                        </h1>
...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    window.location.href= 'uploadpet.php';</script>";
}
?>
 ...
 <?php
    ...
    if (isset($_GET['del'])) {
        ...
        $del_query = "DELETE FROM uploads WHERE ID='$pet_del' AND file_uploader = '$file_uploader' ";
